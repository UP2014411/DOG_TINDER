...
//     FlutterVizBottomNavigationBarModel(icon: Icons.chat, label: "Chat"),
//     FlutterVizBottomNavigationBarModel(
...
//               ),
//               trailing:
//                   Icon(Icons.favorite, color: Color(0xffff0000), size: 24),
//             ),
//             ListTile(
//               tileColor: Color(0x99fff6a4),
//               title: Text(
//                 "You've matched with user_name2",
//                 style: TextStyle(
//                   fontWeight: FontWeight.w400,
//                   fontStyle: FontStyle.normal,
//                   fontSize: 14,
